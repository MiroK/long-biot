...
def get_operator(boundaries, parameters, *, u_dirichlet_tags, p_dirichlet_tags, W, Wbcs, bdry_tags):
...
def get_operator_mixed(boundaries, parameters, *, u_dirichlet_tags, p_dirichlet_tags, W, Wbcs, bdry_tags):
    ...
    # Now components of Espen preconditioner
    def c_form(p, q, ds=ds, hF=hF, nF=nF, gammaF=gammaF):
...
if __name__ == '__main__':
    ...
    result_dir = f'./results/amg_biot2/'
