...
# python3 biot2.py -L 80 -precond standard -ubcs TTDD -pbcs $pbcs -c 0 -nrefs 3
...
# python3 biot2.py -L 80 -precond standard -ubcs TTDD -pbcs $pbcs -c 1 -nrefs 3
...
#     python3 $script -L 80 -precond standard -ubcs TTDD -pbcs $pbcs -c 0 -nrefs 3    
# done
...
#     python3 $script -L 80 -precond espen -ubcs TTDD -pbcs $pbcs -c 0 -nrefs 3    
# done
...
do
    ...
    python3 $script -L 80 -precond espen -ubcs TTDD -pbcs $pbcs -c 0 -nrefs 3 -inverseQ amg    
done
